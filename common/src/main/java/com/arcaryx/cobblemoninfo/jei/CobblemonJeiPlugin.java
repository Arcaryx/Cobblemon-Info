package com.arcaryx.cobblemoninfo.jei;

import com.arcaryx.cobblemoninfo.CobblemonInfo;
import com.arcaryx.cobblemoninfo.data.ClientCache;
import com.arcaryx.cobblemoninfo.jei.drops.DropsJeiCategory;
import com.arcaryx.cobblemoninfo.jei.drops.DropsWrapper;
...
public class CobblemonJeiPlugin implements IModPlugin {
    ...
    public @NotNull ResourceLocation getPluginUid() {
        return new ResourceLocation(CobblemonInfo.MOD_ID);
    }
